...
//import edu.brown.cs.atari_vision.spaceinvaders.policies.NaiveSIPolicy;
...
//                }
//
//                agent = new BurlapAgent(new NaiveSIPolicy(domain), domain, vis, rom);
//                agent.run(episodes);
...
//                Visualizer vis = null;
//
//                agent = new BurlapLearningAgent(learner, domain, vis, rom);
//                agent.run(episodes);
//
//                // save VFA parameters
//                try {
...
//                SADomain domain = domGen.generateDomain();
//
//                agent = new BurlapAgent(new RandomPolicy(domain), domain, null, rom);
//                agent.run(episodes);
//            }
//        }
//    }
...
//                SIDomainConstants.CLASSAGENT,
//                SIDomainConstants.XATTNAME,
//                SIDomainConstants.YATTNAME,
...
//        // Add Alien tiling
//        tilings.add(new ObjectTiling(
//                SIDomainConstants.CLASSALIEN,
//                SIDomainConstants.AGENT_CENT_XATTNAME,
//                SIDomainConstants.AGENT_CENT_YATTNAME,
...
//        // Add Bomb tiling
//        tilings.add(new ObjectTiling(
//                SIDomainConstants.CLASS_BOMB_ALIEN,
//                SIDomainConstants.AGENT_CENT_XATTNAME,
//                SIDomainConstants.AGENT_CENT_YATTNAME,
//                -ALEDomainConstants.ALEScreenWidth,  -ALEDomainConstants.ALEScreenHeight,
//                ALEDomainConstants.ALEScreenWidth, ALEDomainConstants.ALEScreenHeight,
